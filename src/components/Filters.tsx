				...
				<Listbox key={index} {...item}>
					<div className='relative'>
						...
						<Transition
							...
							leaveTo='opacity-0'
						>
							<Listbox.Options className='absolute z-10 mt-1 w-full bg-white border border-gray-800 text-dryGray rounded-md shadow-lg max-h-60 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm'>
